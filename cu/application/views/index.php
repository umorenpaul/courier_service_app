...
<html>
    <head>
        <title>TOPAZ EXPRESS COURIER</title>
        <meta charset="UTF-8">
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url ();?>assets/plugins/bootstrap-select-1.10.0/dist/css/bootstrap-select.min.css">
        <!-- Fonts Css -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url ();?>assets/plugins/font-awesome-4.6.1/css/font-awesome.min.css">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url ();?>assets/plugins/font-elegant/elegant.css">
        <!-- OwlCarousel2 Slider Css -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url ();?>assets/plugins/owl.carousel.2/assets/owl.carousel.css">
                    ...
                    <div class="theme-container container">
                        <div class="row">
                            <div class="col-md-2 col-sm-2">
                                ...
                                <a class="navbar-logo" href="#"> <img src="<?php echo base_url ();?>assets/img/logo/logo-black.png" alt="logo" /> </a>
                            </div>
...
<!-- END OF MAIN CONTENTS -->
	...
	<!-- Footer -->
        ...
        <!-- Bootstrap Select JS -->
        <script src="<?php echo base_url ();?>assets/plugins/bootstrap-select-1.10.0/dist/js/bootstrap-select.min.js" type="text/javascript"></script>    
        <!-- OwlCarousel2 Slider JS -->
        <script src="<?php echo base_url ();?>assets/plugins/owl.carousel.2/owl.carousel.min.js" type="text/javascript"></script>   
        <!-- Sticky Header -->
        <script src="<?php echo base_url ();?>assets/js/jquery.sticky.js"></script>
        <!-- Wow JS -->
        <script src="<?php echo base_url ();?>assets/plugins/WOW-master/dist/wow.min.js" type="text/javascript"></script>
        <!-- Data binder -->
        <script src="<?php echo base_url ();?>assets/plugins/data.binder.js/data.binder.js" type="text/javascript"></script>
