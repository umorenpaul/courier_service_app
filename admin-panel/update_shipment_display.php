...
echo $trackcode=trim($_POST['trackcode']);
...
$result = $db->getData("SELECT * FROM current_destination_act WHERE track_number='$trackcode' ORDER BY curent_destination_act_id DESC LIMIT 1");
