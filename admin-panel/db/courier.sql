...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2024 at 08:01 PM
...
--
-- Table structure for table `current_destination_act`
--

CREATE TABLE IF NOT EXISTS `current_destination_act` (
  `curent_destination_act_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`curent_destination_act_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `current_destination_act`
--

INSERT INTO `current_destination_act` (`curent_destination_act_id`, `act_date`, `act_time`, `comment`, `country_id`, `status`, `track_number`) VALUES
(2, '0000-00-00', '00:00:00', 'Order Processed: Ready for Utopian Courier', 9, 'In Transit', 'UC-1294913907'),
(3, '0000-00-00', '00:00:00', 'Order Processed: Ready for Utopian Courier', 11, 'In Transit', 'TEC-257497509');
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `customer_shipment_type` varchar(50) NOT NULL,
  `delivery_destination_addres` text NOT NULL,
  `destination_country_id` int(6) NOT NULL,
  `expected_delivery_date` varchar(50) NOT NULL,
  `receiver_name` varchar(100) NOT NULL,
  `receiver_phone_num` varchar(20) NOT NULL,
  `sender_country_id` int(8) NOT NULL,
  `sender_state_id` int(6) NOT NULL,
  `sending_date` varchar(50) NOT NULL,
  `shipment_descriptn` varchar(100) NOT NULL,
  `shipment_method_id` int(6) NOT NULL,
...
INSERT INTO `customers` (`customers_id`, `customer_address`, `customer_name`, `customer_phone`, `customer_shipment_type`, `delivery_destination_addres`, `destination_country_id`, `expected_delivery_date`, `receiver_name`, `receiver_phone_num`, `sender_country_id`, `sender_state_id`, `sending_date`, `shipment_descriptn`, `shipment_method_id`, `status`, `tracking_number`, `weight`) VALUES
(5, '12 thttt', 'Paul', '08080432256', 'parcent', '12 ththe df', 16, '0000-00-00', 'Oka', '080841456743', 11, 232, '0000-00-00', 'fdghj', 2, 'IN-TRANSIT', 'TEC-257497509', '');

-- --------------------------------------------------------

--
-- Table structure for table `generated_track_number`
--

CREATE TABLE IF NOT EXISTS `generated_track_number` (
  `generated_track_number_id` int(11) NOT NULL AUTO_INCREMENT,
  `track_no_status` varchar(20) NOT NULL,
  `tracking_no` varchar(50) NOT NULL,
  `gen_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`generated_track_number_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `menue_section`
--

CREATE TABLE IF NOT EXISTS `menue_section` (
  `menue_sectionID` int(11) NOT NULL,
  `menue_sectionName` varchar(255) DEFAULT NULL,
  `menueID` int(11) DEFAULT NULL,
  PRIMARY KEY (`menue_sectionID`),
  KEY `menueID` (`menueID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `shipment_method` (
  `shipment_method_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `shipment_method` (`shipment_method_id`, `method`) VALUES
(1, 'Air'),
(2, 'Land'),
(3, 'Sea');
...
INSERT INTO `user_login` (`user_login_id`, `last_login_time`, `login_ip`, `password`, `username`, `email`, `status`) VALUES
(1, '2024-10-02 12:41:03', '', '827ccb0eea8a706c4c34a16891f84e7b8cb2237d0679ca88db6464eac60da96345513964', 'paul', 'umorenpaul@gmail.com', 1);
...
--
-- Constraints for table `menue_section`
--
ALTER TABLE `menue_section`
  ADD CONSTRAINT `menue_section_ibfk_1` FOREIGN KEY (`menueID`) REFERENCES `menue` (`menueID`);
